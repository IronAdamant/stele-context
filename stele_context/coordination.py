...
from stele_context import agent_registry
from stele_context import change_notifications as _cn
from stele_context import lock_ops
...
class CoordinationBackend:
    ...
    # -- Change notifications (delegated to stele_context.change_notifications) -------
